/**
 * Browser WebSocket client types for OriJS.
 *
 ...
 *
 * This interface is structurally compatible with SocketMessageDefinition from @orijs/core,
 * allowing server-side message definitions to be used directly with the client.
 *
