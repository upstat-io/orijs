...
describe("MapperBuilder", () => {
  describe("build()", () => {
    test("should create mapper from table definition", () => {
      ...
      const mapper = Mapper.for<{ id: number; email: string }>(
        Tables.User,
      ).build();
  ...
  describe("col()", () => {
    ...
    test("should map extra column", () => {
      ...
      const mapper = Mapper.for<UserWithCount>(Tables.User)
        .col<number>("postCount", "post_count")
        .build();
  ...
  describe("field()", () => {
    test("should rename field with as()", () => {
      ...
      const mapper = Mapper.for<UserRenamed>(Tables.User)
        .field("email")
        .as("userEmail")
        .build();
