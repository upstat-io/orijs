...
describe(".col() auto snake_case conversion", () => {
  ...
  describe("edge cases", () => {
    test("should handle property starting with lowercase", () => {
      ...
      const mapper = Mapper.for<UserWithId>(Tables.User)
        .col<number>("id")
        .default(0)
        .build();
    ...
    test("should handle consecutive uppercase letters (acronym at end)", () => {
      ...
      const mapper = Mapper.for<UserWithURL>(Tables.User)
        .col<string>("webhookURL")
        .default("")
        .build();
    ...
    test("should handle acronym at start of property name", () => {
      ...
      const mapper = Mapper.for<UserWithXML>(Tables.User)
        .col<string>("xmlParser")
        .default("")
        .build();
    ...
    test("should handle property that is all lowercase", () => {
      ...
      const mapper = Mapper.for<UserWithStatus>(Tables.User)
        .col<string>("status")
        .default("")
        .build();
    ...
    test("should handle two-letter acronym at end", () => {
      ...
      const mapper = Mapper.for<UserWithIO>(Tables.User)
        .col<number>("diskIO")
        .default(0)
        .build();
    ...
    test("should handle three-letter acronym followed by word", () => {
      ...
      const mapper = Mapper.for<UserWithAPI>(Tables.User)
        .col<string>("apiKeyHash")
        .default("")
        .build();
