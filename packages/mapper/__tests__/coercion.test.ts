 ...
 */
function expectMapperError(
  fn: () => void,
  expected: { table: string; column: string; type: string },
): void {
  try {
    fn();
...
describe("coercion functions", () => {
  describe("coerceNumber()", () => {
    ...
    test("should throw MapperError when input is non-numeric string", () => {
      expect(() => coerceNumber("abc", "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
    ...
    test("should throw MapperError when input is null", () => {
      expect(() => coerceNumber(null, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });

    test("should throw MapperError when input is undefined", () => {
      expect(() => coerceNumber(undefined, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });

    test("should throw MapperError when input is empty string", () => {
      expect(() => coerceNumber("", "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
  ...
  describe("coerceDate()", () => {
    ...
    test("should throw MapperError when input is invalid date string", () => {
      expect(() => coerceDate("not-a-date", "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
    ...
    test("should throw MapperError when input is null", () => {
      expect(() => coerceDate(null, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });

    test("should throw MapperError when input is undefined", () => {
      expect(() => coerceDate(undefined, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });

    test("should throw MapperError when input is empty string", () => {
      expect(() => coerceDate("", "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
  ...
  describe("coerceDate() boundary values", () => {
    ...
    test("should throw MapperError when timestamp exceeds maximum", () => {
      ...
      expect(() => coerceDate(beyondMax, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
  ...
  describe("coerceString()", () => {
    ...
    test("should throw MapperError when input is null", () => {
      expect(() => coerceString(null, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
    ...
    test("should throw MapperError when input is undefined", () => {
      expect(() => coerceString(undefined, "test_table", "test_col")).toThrow(
        MapperError,
      );
    });
