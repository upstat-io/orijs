 ...
 */
export type WebSocketConnection<TData = unknown> = ServerWebSocket<
  SocketData<TData>
>;
 ...
 * ```
 */
export const WebSocketProviderToken: symbol & {
  readonly __type?: WebSocketProvider;
} = Symbol("WebSocketProvider") as symbol & {
  readonly __type?: WebSocketProvider;
};
