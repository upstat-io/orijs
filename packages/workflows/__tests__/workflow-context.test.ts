...
describe("WorkflowContext", () => {
  ...
  describe("DefaultWorkflowContext", () => {
    it("should create context with all properties", () => {
      ...
      const ctx = new DefaultWorkflowContext(
        flowId,
        data,
        results,
        testLogger,
    ...
    it("should preserve data type", () => {
      ...
      const ctx = new DefaultWorkflowContext<OrderData>(
        "flow-1",
        data,
        {},
        testLogger,
      ...
      it("should reject null meta", () => {
        expect(() => {
          createWorkflowContext(
            ...
            {},
            testLogger,
            null as unknown as PropagationMeta,
          );
  ...
  describe("accumulated results (Q4)", () => {
    it("should provide access to accumulated step results", () => {
      ...
      expect(ctx.results["notify"]).toEqual({
        emailSent: true,
        smsSent: false,
      });
    });
