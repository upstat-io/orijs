...
describe("Definition-Based Registration", () => {
  ...
  describe("Event Registration", () => {
    ...
    it("should allow chaining after event registration", async () => {
      class OrderHandler implements IEventConsumer<
        (typeof OrderPlaced)["_data"],
        void
      > {
        onEvent = async () => {};
      }
    ...
    it("should return undefined for unregistered event definition", async () => {
      ...
      expect(
        eventCoordinator.getEventDefinition("unregistered.event"),
      ).toBeUndefined();
    });
  });
  ...
  describe("Workflow Registration", () => {
    ...
    it("should register workflow definition without consumer", async () => {
      ...
      expect(
        workflowCoordinator.getWorkflowDefinition("send-email"),
      ).toBeDefined();
    });
    ...
    it("should register workflow definition with consumer", async () => {
      ...
      > {
        onComplete = async (
          _ctx: WorkflowContext<(typeof SendEmail)["_data"]>,
        ) => {
    ...
    it("should register workflow consumer with dependencies", async () => {
      ...
      > {
        ...
        onComplete = async (
          ctx: WorkflowContext<(typeof SendEmail)["_data"]>,
        ) => {
      ...
      app = Ori.create()
        .provider(SmtpClient)
        .workflow(SendEmail)
        .consumer(SendEmailWorkflow, [SmtpClient]);
  ...
  describe("Duplicate Detection", () => {
    it("should throw on duplicate event registration", async () => {
      ...
      class Consumer1 implements IEventConsumer<
        (typeof DuplicateEvent)["_data"],
        void
      > {
        onEvent = async () => {};
      }
    ...
    it("should throw on duplicate workflow registration", async () => {
      ...
      class Workflow1 implements IWorkflowConsumer<
        (typeof DuplicateWorkflow)["_data"],
        void
      > {
        onComplete = async () => {};
      }
