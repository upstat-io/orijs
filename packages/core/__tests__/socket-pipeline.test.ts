...
import {
  SocketPipeline,
  type CompiledSocketRoute,
} from "../src/sockets/socket-pipeline.ts";
...
import type {
  SocketGuard,
  SocketContextLike,
} from "../src/types/socket-router.ts";
...
describe("SocketPipeline", () => {
  ...
  function createRoute(
    overrides: Partial<CompiledSocketRoute> = {},
  ): CompiledSocketRoute {
    return {
      messageType: "test",
