...
describe("IEventConsumer", () => {
  ...
  describe("class implementation", () => {
    it("should allow class-based consumer implementation", async () => {
      ...
      > {
        onEvent = async (
          ctx: EventContext<UserCreatedPayload>,
...
describe("IWorkflowConsumer", () => {
  ...
  describe("steps property", () => {
    ...
    it("should allow step handlers to be executed", async () => {
      ...
      const consumer: IWorkflowConsumer<
        TestData,
        { done: boolean },
        TestSteps
      > = {
  ...
  describe("class implementation", () => {
    it("should allow class-based workflow implementation", async () => {
      ...
      > {
        onComplete = async (
          ctx: WorkflowContext<ProcessOrderData>,
        ): Promise<ProcessOrderResult> => {
          const totalItems = ctx.data.items.reduce(
        ...
        onError = async (
          _ctx: WorkflowContext<ProcessOrderData>,
          error: Error,
        ): Promise<void> => {
    ...
    it("should allow class-based workflow with steps", async () => {
      ...
      class OrderWorkflow implements IWorkflowConsumer<
        OrderData,
        OrderResult,
        OrderSteps
      > {
        ...
        onComplete = async (
          ctx: WorkflowContext<OrderData, OrderSteps>,
        ): Promise<OrderResult> => {
