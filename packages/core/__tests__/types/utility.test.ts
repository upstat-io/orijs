...
describe("Functional Integration - Consumer Class Implementations", () => {
  ...
  it("should allow implementing a full consumer class with EventConsumer<T>", () => {
    ...
    class OrderPlacedConsumer implements EventConsumer<typeof OrderPlaced> {
      ...
      onEvent = async (
        ctx: EventCtx<typeof OrderPlaced>,
      ): Promise<Result<typeof OrderPlaced>> => {
      ...
      onSuccess = async (
        _ctx: EventCtx<typeof OrderPlaced>,
        result: Result<typeof OrderPlaced>,
      ) => {
        // Access typed result
  ...
  it("should allow implementing workflow consumer with WorkflowConsumer<T>", () => {
    ...
    class ProcessRefundWorkflow implements WorkflowConsumer<
      typeof ProcessRefund
    > {
      onComplete = async (
        ctx: WorkflowCtx<typeof ProcessRefund>,
      ): Promise<Result<typeof ProcessRefund>> => {
      ...
      onError = async (
        _ctx: WorkflowCtx<typeof ProcessRefund>,
        error: Error,
      ) => {
