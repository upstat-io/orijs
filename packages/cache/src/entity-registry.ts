...
> implements EntityRegistryBuilder<TEntityNames, TScopeNames> {
  ...
  public scope<S extends string>(
    ...
    return this as unknown as EntityRegistryBuilder<
      TEntityNames,
      TScopeNames | S
    >;
  }
 ...
 * ```
 */
export function defineScopes<T extends ScopeDefsInput>(
  scopes: T,
): ScopeDefsOutput<T>;
 ...
 * ```
 */
export function defineEntities<T extends EntityDefsInput>(
  entities: T,
): EntityDefsOutput<T>;
 ...
 */
export function getEntityInvalidationTags(
  entityName: string,
