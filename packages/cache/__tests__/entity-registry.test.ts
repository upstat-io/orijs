...
describe("EntityRegistry", () => {
  describe("scope()", () => {
    ...
    it("should inherit params from previous scopes", () => {
      ...
      expect(registry.getScope("project").params).toEqual([
        "accountUuid",
        "projectUuid",
      ]);
    });
  ...
  describe("use()", () => {
    it("should apply composition function to add entities", () => {
      ...
      expect(registry.getEntity("User").params).toEqual([
        "accountUuid",
        "fbAuthUid",
      ]);
      expect(registry.getEntity("UserProfile").params).toEqual([
        "accountUuid",
        "fbAuthUid",
      ]);
    });
    ...
    it("should allow composition functions that add scopes", () => {
      ...
      expect(registry.getEntity("Monitor").params).toEqual([
        "accountUuid",
        "projectUuid",
        "monitorUuid",
      ]);
  ...
  describe("real-world usage", () => {
    it("should build a complete multi-tenant entity registry", () => {
      ...
      function addUserEntities<T extends string, S extends string>(
        ...
        T | "User" | "UserProfile" | "AccountUsersCollection",
        S
      > {
        return reg
          .entity("User", "account" as S, "fbAuthUid")
      ...
      function addMonitorEntities<T extends string, S extends string>(
        ...
        T | "Monitor" | "MonitorSettings" | "MonitorCollection",
        S
      > {
        return reg
      ...
      expect(registry.getEntity("MonitorCollection").params).toEqual([
        "accountUuid",
        "projectUuid",
      ]);
      expect(registry.getEntity("Incident").params).toEqual([
        "accountUuid",
        "projectUuid",
        "incidentUuid",
      ]);
