...
describe("generateCacheKey", () => {
  describe("basic functionality", () => {
    it("should generate a cache key with correct prefix", () => {
      const config = createTestConfig<UserParams>("User", [
        "accountUuid",
        "userUuid",
      ]);
    ...
    it("should generate different keys for different entity types", () => {
      const userConfig = createTestConfig<UserParams>("User", [
        "accountUuid",
        "userUuid",
      ]);
      const teamConfig = createTestConfig<UserParams>("Team", [
        "accountUuid",
        "userUuid",
      ]);

      const key1 = generateCacheKey(userConfig, {
        accountUuid: "abc",
        userUuid: "def",
      });
      const key2 = generateCacheKey(teamConfig, {
        accountUuid: "abc",
        userUuid: "def",
      });
  ...
  describe("missing required params validation", () => {
    it("should throw when a declared param is undefined", () => {
      ...
      expect(() =>
        generateCacheKey(config, { a: 1, b: undefined } as any),
      ).toThrow("Missing required cache params for 'Test': b");
    });
    ...
    it("should include helpful message about cache isolation", () => {
      ...
      ).toThrow("to ensure cache isolation");
    });
    ...
    it("should not throw when all declared params are provided", () => {
      ...
      expect(() =>
        generateCacheKey(config, { accountUuid: "abc", userUuid: "def" }),
      ).not.toThrow();
    });
  ...
  describe("error cases", () => {
    it("should throw for null config", () => {
      expect(() =>
        generateCacheKey(null as any, { accountUuid: "abc", userUuid: "def" }),
      ).toThrow("CacheConfig is required");
    });

    it("should throw for config without entity", () => {
      const config = {
        ...createTestConfig<UserParams>("User", ["accountUuid"]),
        entity: "",
      };
      expect(() =>
        generateCacheKey(config as any, {
          accountUuid: "abc",
          userUuid: "def",
        }),
      ).toThrow("CacheConfig.entity is required");
    });
    ...
    it("should throw for null params", () => {
      ...
      expect(() => generateCacheKey(config, null as any)).toThrow(
    ...
    it("should throw for undefined params", () => {
      ...
      expect(() => generateCacheKey(config, undefined as any)).toThrow(
        "Params must be an object",
      );
    });
  });
...
describe("generateMetaKey", () => {
  describe("basic functionality", () => {
    ...
    it("should generate different keys for different projectUuid", () => {
      const key1 = generateMetaKey("Monitor", {
        accountUuid: "abc",
        projectUuid: "proj1",
      });
      const key2 = generateMetaKey("Monitor", {
        accountUuid: "abc",
        projectUuid: "proj2",
      });
  ...
  describe("scope combinations", () => {
    ...
    it("should handle project-level meta key (with projectUuid)", () => {
      const key = generateMetaKey("Monitor", {
        accountUuid: "abc",
        projectUuid: "xyz",
      });
  ...
  describe("undefined handling", () => {
    ...
    it("should ignore undefined projectUuid", () => {
      const key1 = generateMetaKey("User", {
        accountUuid: "abc",
  ...
  describe("error cases", () => {
    it("should throw for empty entity type", () => {
      expect(() => generateMetaKey("" as any, { accountUuid: "abc" })).toThrow(
        "Entity type is required",
      );
    });

    it("should throw for null params", () => {
      expect(() => generateMetaKey("User", null as any)).toThrow(
        "Params must be an object",
      );
    });

    it("should throw for undefined params", () => {
      expect(() => generateMetaKey("User", undefined as any)).toThrow(
        "Params must be an object",
      );
    });
  });
...
describe("generateConfigMetaKey", () => {
  describe("basic functionality", () => {
    it("should generate meta key using config metaParams", () => {
      const config = createTestConfig<UserParams>(
        "User",
        ["accountUuid", "userUuid"],
        ["accountUuid"],
      );
      const key = generateConfigMetaKey(config, {
        accountUuid: "abc",
        userUuid: "def",
      });
    ...
    it("should only include metaParams in the key", () => {
      ...
      const key1 = generateConfigMetaKey(config, {
        accountUuid: "abc",
        userUuid: "def",
      });
      const key2 = generateConfigMetaKey(config, {
        accountUuid: "abc",
        userUuid: "xyz",
      });
  ...
  describe("missing required metaParams validation", () => {
    it("should throw when a declared metaParam is undefined", () => {
      ...
      expect(() =>
        generateConfigMetaKey(config, {
          accountUuid: undefined,
          userUuid: "def",
        } as any),
      ).toThrow("Missing required meta params for 'User': accountUuid");
    });
    ...
    it("should include helpful message about cascade invalidation", () => {
      ...
      ).toThrow("for cascade invalidation");
    });
