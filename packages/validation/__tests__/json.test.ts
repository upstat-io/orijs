...
describe("Json", () => {
  ...
  describe("parse", () => {
    describe("prototype pollution prevention", () => {
      ...
      it("should handle deeply nested dangerous keys", () => {
        ...
        expect(
          Object.prototype.hasOwnProperty.call(result.a.b.c, "prototype"),
        ).toBe(false);
      });
    });
    ...
    describe("normal JSON parsing", () => {
      it("should parse simple objects", () => {
        const result = Json.parse<{ name: string; age: number }>(
          '{"name": "test", "age": 42}',
        );
      ...
      it("should parse nested objects", () => {
        const result = Json.parse<{ user: { name: string } }>(
          '{"user": {"name": "test"}}',
        );
      ...
      it("should support reviver function", () => {
        const result = Json.parse<{ date: Date }>(
    ...
    describe("edge cases", () => {
      ...
      it("should handle arrays with mixed object types", () => {
        ...
        expect(
          Object.prototype.hasOwnProperty.call(result[3], "__proto__"),
        ).toBe(false);
      });
    });
  });
  ...
  describe("sanitize", () => {
    ...
    it("should sanitize nested structures", () => {
      ...
      expect(
        Object.prototype.hasOwnProperty.call(result.level1, "__proto__"),
      ).toBe(false);
      expect(
  ...
  describe("performance characteristics", () => {
    it("should handle large objects efficiently", () => {
      ...
      (largeObject as Record<string, unknown>)["__proto__"] = {
        polluted: true,
      };
